...
public static WebDriver oBrowser=null;
	...
	static void modifycustomer()
	{
		try
		{
			...
			Thread.sleep(3000);
			oBrowser.findElement(objectmap.getLocator("customernamemodification")).clear();
			Thread.sleep(3000);
			oBrowser.findElement(objectmap.getLocator("customernamemodification")).sendKeys("NewCustomer1");
			Thread.sleep(3000);
			oBrowser.findElement(objectmap.getLocator("clickoncustomeragain")).click();
			Thread.sleep(3000);
		}catch(Exception e)
